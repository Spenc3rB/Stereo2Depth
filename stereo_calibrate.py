...
def stereo_calibrate(mtx0, dist0, mtx1, dist1, frames_prefix_c0, frames_prefix_c1):
    ...
    rectifyScale = 1
    R1, R2, P1, P2, _, _, _ = cv.stereoRectify(CM1, dist0, CM2, dist1, (width, height), R, T, rectifyScale, (0,0))

    stereoMap0 = cv.initUndistortRectifyMap(CM1, dist0, R1, P1, (width, height), cv.CV_16SC2)
    stereoMap1 = cv.initUndistortRectifyMap(CM2, dist1, R2, P2, (width, height), cv.CV_16SC2)
